...
```bash
npx -y @memi-design/cli@2.8.0-beta.1 agent brief . --agent hermes --intent "<interface task>" --detail compact --json
```
...
npx -y @memi-design/cli@2.8.0-beta.1 tokens --from ./src --report --json
```
