...
```bash
npx -y @memi-design/cli@2.6.3 agent brief . --agent hermes --intent "<interface task>" --detail compact --json
```
...
npx -y @memi-design/cli@2.6.3 ux audit . --json --no-write
npx -y @memi-design/cli@2.6.3 tokens --from ./src --report --json
```
