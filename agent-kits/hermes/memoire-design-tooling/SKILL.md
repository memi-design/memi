...
```bash
npx -y @memi-design/cli@2.7.8 agent brief . --agent hermes --intent "<interface task>" --detail compact --json
```
...
npx -y @memi-design/cli@2.7.8 ux audit . --json --no-write
npx -y @memi-design/cli@2.7.8 tokens --from ./src --report --json
```
