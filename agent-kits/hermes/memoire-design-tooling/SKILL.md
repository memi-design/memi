...
```bash
npx -y @memi-design/cli@2.7.4 agent brief . --agent hermes --intent "<interface task>" --detail compact --json
```
...
npx -y @memi-design/cli@2.7.4 ux audit . --json --no-write
npx -y @memi-design/cli@2.7.4 tokens --from ./src --report --json
```
