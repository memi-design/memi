...
Current release: `@memi-design/cli@2.6.4`
...
npx -y @memi-design/cli@2.6.4 diagnose . --no-write
...
```text
Memi 2.6.4: one read-only command before your agent edits UI
```

Body:

```text
Memi 2.6.4 is now published across npm, GitHub Releases, the v2 Action channel,
Homebrew, GHCR, MCP Registry metadata, and the public docs.
