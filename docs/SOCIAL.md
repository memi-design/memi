...
Current release: `@memi-design/cli@2.7.9`
...
npx -y @memi-design/cli@2.7.9 diagnose . --no-write
...
```text
Memi 2.7.9: one grounded command before your agent edits UI
```

Body:

```text
Memi 2.7.9 is published on npm. GitHub release, the v2 Action channel, MCP
