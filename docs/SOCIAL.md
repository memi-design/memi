...
Current release: `@memi-design/cli@2.7.3`
...
npx -y @memi-design/cli@2.7.3 diagnose . --no-write
...
```text
Memi 2.7.3: one read-only command before your agent edits UI
```

Body:

```text
Memi 2.7.3 is published on npm, GitHub Releases, the v2 Action channel, and
