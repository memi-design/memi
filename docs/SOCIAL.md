...
Current release: `@memi-design/cli@2.7.1`
...
npx -y @memi-design/cli@2.7.1 diagnose . --no-write
...
```text
Memi 2.7.1: one read-only command before your agent edits UI
```

Body:

```text
Memi 2.7.1 is published on npm, GitHub Releases, the v2 Action channel, and
