...
Current release: `@memi-design/cli@2.7.0`
...
npx -y @memi-design/cli@2.7.0 diagnose . --no-write
...
```text
Memi 2.7.0: one read-only command before your agent edits UI
```

Body:

```text
Memi 2.7.0 is published on npm, GitHub Releases, the v2 Action channel, and
