...
def _remediation_tex(summary: Mapping[str, Any]) -> str:
    return (
        ...
        "through \\texttt{52107c8b}; this source-level statement does not establish a "
        "published release.\n\n"
        ...
        "At reviewed tip \\texttt{52107c8b}, the local full suite passed 2,226 tests across "
        "309 files; typecheck and build passed. The replay harness additionally pins frozen "
