...
def _remediation_tex(summary: Mapping[str, Any]) -> str:
    return (
        ...
        "through \\texttt{ffa3c108}; this source-level statement does not establish a "
        "published release.\n\n"
        ...
        "At reviewed tip \\texttt{ffa3c108}, the local full suite passed 2,223 tests across "
        "308 files; typecheck and build passed; and the second security review reported no "
        "actionable findings. These are local engineering checks, not public-channel proof. "
