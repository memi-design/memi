...
% separate live-evidence gate and therefore remains fail-closed unless the
% deterministic report-package builder admits a live verification ledger.
\IfFileExists{generated/tex/release-status.tex}{%
  \input{generated/tex/release-status.tex}%
}{}
...
\newcommand{\ClaimDecisionFigure}{%
  \IfFileExists{generated/figures/claim-decision.png}{%
    \includegraphics[width=\linewidth]{generated/figures/claim-decision.png}%
  }{\FigurePlaceholder{What the V15 study establishes and does not establish.}}%
}

\newcommand{\StudyDesignFigure}{%
  \IfFileExists{generated/figures/study_design.png}{%
    \includegraphics[width=\linewidth]{generated/figures/study_design.png}%
  }{\FigurePlaceholder{Prospective matched-pair design and evidence boundary.}}%
}
...
\newcommand{\PolicyFigure}{%
  \IfFileExists{generated/figures/routing_policy_state_machine.png}{%
    \includegraphics[width=\linewidth]{generated/figures/routing_policy_state_machine.png}%
  }{\FigurePlaceholder{Fail-closed exact-route routing policy.}}%
}
