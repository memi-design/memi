  ...
  memoire: z.object({
    ...
    routing: z.object({
      ...
      repository: z.object({
        ...
        importsAny: z.array(z.string().min(1).max(160)).max(24).optional(),
        scriptsAny: z.array(z.string().min(1).max(160)).max(24).optional(),
        frameworksAny: z.array(z.string().min(1).max(160)).max(24).optional(),
        languagesAny: z.array(z.string().min(1).max(160)).max(24).optional(),
        excludeFilesAny: z.array(z.string().min(1).max(160)).max(24).optional(),
      }).strict().optional(),
    }).strict().optional(),
  }).optional(),
